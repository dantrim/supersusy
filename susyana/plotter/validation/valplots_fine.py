...
## nVtx
p = plot.Plot1D()
p.initialize("wwPre", "nVtx", "wwPre_nVtx")
...
## mu
p = plot.Plot1D()
p.initialize("wwPre", "avgMu", "wwPre_avgMu")
...
## leptons
p = plot.Plot1D()
p.initialize("wwPre", "l_pt[0]", "wwPre_lpt0")
...
p = plot.Plot1D()
p.initialize("wwPre", "l_pt[1]", "wwPre_lpt1")
...
p = plot.Plot1D()
p.initialize("wwPre", "l_eta[0]", "wwPre_leta0")
...
p = plot.Plot1D()
p.initialize("wwPre", "l_eta[1]", "wwPre_leta1")
...
p = plot.Plot1D()
p.initialize("wwPre", "l_phi[0]", "wwPre_lphi0")
...
p = plot.Plot1D()
p.initialize("wwPre", "l_phi[1]", "wwPre_lphi1")
...
p = plot.Plot1D()
p.initialize("wwPre", "pTll", "wwPre_pTll")
...
p = plot.Plot1D()
p.initialize("wwPre", "dphi_ll", "wwPre_dphi_ll")
...
p = plot.Plot1D()
p.initialize("wwPre", "mll", "wwPre_mll")
...
## jets
p = plot.Plot1D()
p.initialize("wwPre", "nSJets", "wwPre_nSJets")
...
p = plot.Plot1D()
p.initialize("wwPre", "sj_pt[0]", "wwPre_sjpt0")
...
p = plot.Plot1D()
p.initialize("wwPre", "sj_eta[0]", "wwPre_sjeta0")
...
p = plot.Plot1D()
p.initialize("wwPre", "sj_pt[1]", "wwPre_sjpt1")
...
p = plot.Plot1D()
p.initialize("wwPre", "sj_eta[1]", "wwPre_sjeta1")
...
p = plot.Plot1D()
p.initialize("wwPre", "mt2", "wwPre_mt2")
...
#### met plots
p = plot.Plot1D()
p.initialize("wwPre", "met", "wwPre_met")
...
p = plot.Plot1D()
p.initialize("wwPre", "metPhi", "wwPre_metPhi")
...
p = plot.Plot1D()
p.initialize("wwPre", "refEle_et", "wwPre_refEle_et")
...
p = plot.Plot1D()
p.initialize("wwPre", "refJet_et", "wwPre_refJet_et")
...
p = plot.Plot1D()
p.initialize("wwPre", "softTerm_et", "wwPre_softTerm_et")
...
p = plot.Plot1D()
p.initialize("wwPre", "refMuo_et", "wwPre_refMuo_et")
...
p = plot.Plot1D()
p.initialize("wwPre", "sumet", "wwPre_sumet")
...
p = plot.Plot1D()
p.initialize("wwPre", "refEle_sumet", "wwPre_refEle_sumet")
...
p = plot.Plot1D()
p.initialize("wwPre", "refJet_sumet", "wwPre_refJet_sumet")
...
p = plot.Plot1D()
p.initialize("wwPre", "softTerm_sumet", "wwPre_softTerm_sumet")
...
p = plot.Plot1D()
p.initialize("wwPre", "refMuo_sumet", "wwPre_refMuo_sumet")
