...
# Set up the samples
#############################################
scratchdir = "/scratch/dantrim/n0210/"
...
p.labels(x="TST #slash{E}_{T} (no JVT cut) [GeV]", y="Entries / 5 GeV")
p.xax(5, 0, 200)
p.yax(0.1, 100000)
p.doLogY = True
p.setRatioCanvas(p.name)
...
p.labels(x="TST #slash{E}_{T} jet term (no JVT cut) [GeV]", y="Entries / 10 GeV")
p.xax(10, 0, 300)
p.yax(0.1, 100000)
p.doLogY = True
p.setRatioCanvas(p.name)
...
p.labels(x="TST #slash{E}_{T} muon term (no JVT cut) [GeV]", y="Entries / 10 GeV")
p.xax(10, 0, 300)
p.yax(0.1, 100000)
p.doLogY = True
p.setRatioCanvas(p.name)
...
p.labels(x="TST #slash{E}_{T} soft term (no JVT cut) [GeV]", y="Entries / 2 GeV")
p.xax(2, 0, 60)
p.yax(0.1, 100000)
p.doLogY = True
p.setRatioCanvas(p.name)
...
p.labels(x="TST #slash{E}_{T}-x (no JVT cut) [GeV]", y="Entries / 5 GeV")
p.xax(5, -130, 130)
p.yax(0.1, 10000)
p.doLogY = True
p.setRatioCanvas(p.name)
...
p.labels(x="TST #slash{E}_{T}-y (no JVT cut) [GeV]", y="Entries / 5 GeV")
p.xax(5, -130, 130)
p.yax(0.1, 10000)
p.doLogY = True
p.setRatioCanvas(p.name)
...
p.labels(x="#Delta#phi(#slash{E}_{T}, jet-Term) (no JVT cut)", y="Entries")
p.xax(0.2, -3.2, 3.2)
p.yax(0.1, 10000)
p.doLogY = True
p.setRatioCanvas(p.name)
...
p.labels(x="#Delta#phi(#slash{E}_{T}, muon-Term) (no JVT cut)", y="Entries")
p.xax(0.2, -3.2, 3.2)
p.yax(0.1, 10000)
p.doLogY = True
p.setRatioCanvas(p.name)
...
p.labels(x="#Delta#phi(#slash{E}_{T}, soft-Term) (no JVT cut)", y="Entries")
p.xax(0.2, -3.2, 3.2)
p.yax(0.1, 10000)
p.doLogY = True
p.setRatioCanvas(p.name)
