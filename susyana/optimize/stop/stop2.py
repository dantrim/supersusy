...
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && DPB>2.5 && nBJets==0 && mt2>85 && pBll>40 && R2>0.65"
# mt2 --> 65 and no pbll
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && DPB>2.5 && nBJets==0 && mt2>65 && R2>0.65"
# same as above, dpb --> 2
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && DPB>2 && nBJets==0 && mt2>65 && R2>0.65"
# same as above, remove dbp, pbll -> 100
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && pBll>100 && nBJets==0 && mt2>65 && R2>0.6"
# add R1, rid of R2
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && DPB>2.5 && pBll>100 && nBJets==0 && mt2>65 "#&& R1>0.6"

#possible
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && meff<180 && DPB>(0.4*abs(cosThetaB) + 2) && nBJets==0 && mt2>40"
...
#n-1 R2
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && DPB>2.5 && nBJets==0 && mt2>85 && pBll>40"
#n-1 PBLL
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && DPB>2.5 && nBJets==0 && mt2>85 && R2>0.65"
#n-1 DPB
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && nBJets==0 && mt2>85 && pBll>40 && R2>0.65"
#n-1 mt2
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && DPB>2.5 && nBJets==0  && pBll>40 && R2>0.65"
#n-1 nBJets
#reg.tcut = "nLeptons==2 && nMuons==1 && nElectrons==1 && (l_q[0]*l_q[1])<0 && l_pt[0]>20 && l_pt[1]>20 && DPB>2.5 && mt2>85 && pBll>40 && R2>0.65"
regions.append(reg)
