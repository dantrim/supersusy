...
#    ExpectedLimitWithBands(50,7)
    print ExpectedSignificance(8.53, 7.58, 2.39)
#    print ExpectedLimit(6.92, 2.08)
#    print ExpectedSignificance(0.88, 6.92, 2.08)
#    print ExpectedSignificance(2.55, 6.92, 2.08)
